...
export default function FullServiceSignupPage() {
        ...
        <Card className="max-w-2xl w-full bg-white/80 backdrop-blur-lg border-0 shadow-2xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Your application for the Full-Service Package has been received. I'll contact you within 24 hours to
              discuss next steps and schedule a property consultation.
            </p>
            <Link href="/">
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Package Details */}
            <div>
              <Card className="bg-white/80 backdrop-blur-lg border-0 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 relative">
                ...
                <CardContent>
                  <p className="text-gray-700 mb-6 text-center text-lg">Complete management for busy property owners</p>
                  <ul className="space-y-4">
                    {[
                      "Guest messaging and communication",
                      "Calendar updates and availability management",
                      "Professional cleaning scheduling",
                      "Smart pricing updates and optimization",
                      "Review management and responses",
                      "Maintenance coordination and help",
                    ].map((feature, index) => (
              ...
              <Card className="bg-white/80 backdrop-blur-lg border-0 shadow-2xl">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Cleaning Needs</label>
                      <select
                        name="cleaningNeeds"
                        value={formData.cleaningNeeds}
                        onChange={handleChange}
                        className="w-full px-3 py-2 border-2 border-blue-200 focus:border-blue-500 rounded-xl shadow-lg focus:outline-none"
                      >
                        <option value="">Select cleaning frequency</option>
                        <option value="after-each-guest">After each guest</option>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={handleChange}
                        placeholder="Tell me about your goals and any specific needs..."
                        className="border-2 border-blue-200 focus:border-blue-500 rounded-xl shadow-lg"
                        rows={4}
                      />
                    </div>
