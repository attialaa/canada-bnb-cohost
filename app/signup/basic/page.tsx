        ...
        <Card className="max-w-2xl w-full bg-white/80 backdrop-blur-lg border-0 shadow-2xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Your application for the Basic Package has been received. I'll contact you within 24 hours to discuss next
              steps.
            </p>
            <Link href="/">
              ...
              <Card className="bg-white/80 backdrop-blur-lg border-0 shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-gray-700 mb-6 text-center text-lg">
                    Perfect for hands-on owners who want essential support
                  </p>
                  <ul className="space-y-4">
                    {[
                      "Guest messaging and communication",
                      "Calendar updates and availability management",
                      "24/7 emergency support for urgent issues",
                    ].map((feature, index) => (
